...
public class c1_Introduction extends IntroductionBase {
    ...
    public void multi_result_service() {
        ...
        String result = serviceResult.take(1)
                                     .blockFirst();
    ...
    public void nothing_happens_until_you_() throws InterruptedException {
        ...
        //bonus: can you explain why this line is needed?
        // a: main thread calls are async and may equals assertion may happen ahead of list being populated
        Thread.sleep(1000);
    ...
    public void leaving_blocking_world_behind() throws InterruptedException {
        ...
        fortuneTop5()
                .take(5)
                .subscribe(companyList::add, ex -> {}, () -> serviceCallCompleted.set(true));
